...
function step($path){
	...
	$visited_filtered = array_filter($visited, function ($string) {
    	return $string === strtolower($string);
	});
	
	if (count(array_flip($visited_filtered)) != count($visited_filtered)){
		$visited = $visited_filtered;
	} else {
		$visited = [$begin];
	}
